...
char      chPassword[] =                  "SENHA SEU WIFI";               // your network password 
char      chSSID[] =                      "SEU ID NA REDE";                 // your network SSID
...
void setup()
{
  ...
  // Wifi.
    ...
    u8g2.clearBuffer();
    sprintf(chBuffer, "%s", "Conectando a rede :");
    ...
    Serial.print("Lora Clock: conectando ao Wifi");
    ...
    Serial.println();
    sprintf(chBuffer, "Lora Clock: Conectado a rede %s.", chSSID);
    ...
    // Display connection stats.
      ...
      sprintf(chBuffer, "%s", " Valores do WiFi:");
      u8g2.drawStr(64 - (u8g2.getStrWidth(chBuffer) / 2), 0, chBuffer);
      ...
      u8g2.drawStr(0, FONT_ONE_HEIGHT * 4, "Aguardando dados...");
     ...
     // Have yet to receive time from the ntp server, update delay counter.
      ...
      if(nNtpDelay >= NTP_DELAY_COUNT)
      {
          ...
          // Send ntp time request.
            ...
            Serial.println("Lora Clock: pacote enviado ao servidor.");
            Serial.print("Lora Clock: aguardando resposta do servidor");
      }
      ...
      if(nNtpDelay == (NTP_DELAY_COUNT - 1))
      {
          ...
          if(Udp.parsePacket())
          {
              ...
              Serial.println();
              Serial.print("Lora Clock: resposta recebida, horário escrito para o rtc: ");
              Serial.println(chBuffer); 
          ...
          else
          {
              ...
              Serial.println("Lora Clock: pacote não recebido.");
          }
      }
  }
