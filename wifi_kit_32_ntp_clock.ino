...
char chPassword[] = "your network SSID"; // your network SSID
...
void loop()
{
  ...
  if (bTimeReceived == false)
  {
    ...
    if (nNtpDelay >= NTP_DELAY_COUNT)
    {
      ...
      // Send the ntp packet.
      // IPAddress ipNtpServer(129, 6, 15, 28); Currently Down - November 17, 2021
      IPAddress ipNtpServer(200, 186, 125, 195); //From Brazil
